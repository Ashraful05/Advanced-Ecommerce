...
@section('title','Easy Online Shop')
@section('content')
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                        ...
                        <div class="more-info-tab clearfix ">
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                ...
                                @foreach($categories as $category)
                                    <li><a data-transition-type="backSlide" href="#category{{ $category->id }}" data-toggle="tab">@if(Session::get('language')=='english') {{ $category->category_name_english }} @else {{ $category->category_name_bangla }} @endif</a></li>
                                @endforeach
                                            ...
                                            <div class="item item-carousel">
                                                <div class="products">
                                                    <div class="product">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="{{ url('product-details/'.$product->id.'/'.$product->product_name_english) }}">
                                                        ...
                                                        <div class="product-info text-left">
                                                            <h3 class="name"><a href="{{url('product-details/'.$product->id.'/'.$product->product_slug_english)}}">@if(Session::get('language')=='english'){{ $product->product_name_english }} @else {{ $product->product_name_bangla }} @endif</a></h3>
                                                            <div class="rating rateit-small"></div>
                                                            <div class="description"></div>
                                                            @if($product->discount_price==Null)
                                                                <div class="product-price"> <span class="price"> ${{ $product->selling_price }} </span> <span class="price-before-discount"></span> </div>
                                                            @else
                            ...
                            @foreach($categories as $category)
                                <div class="tab-pane " id="category{{ $category->id }}">
                                    <div class="product-slider">
                                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                            @php
                                                $categoryWiseProduct = \App\Models\Product::where('category_id',$category->id)->orderby('id','desc')->get();
                                            @endphp
                    ...
                    <section class="section featured-product wow fadeInUp">
                        <h3 class="section-title">
                            @if(Session::get('language')=='english'){{ $skip_category_0->category_name_english }}
                            @else{{ $skip_category_0->category_name_bangla }}
                            @endif
                        </h3>
                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                    ...
                    <section class="section featured-product wow fadeInUp">
                        <h3 class="section-title">
                            @if(Session::get('language')=='english'){{ $skip_category_1->category_name_english }}
                            @else{{ $skip_category_1->category_name_bangla }}
                            @endif
                        </h3>
                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                    ...
                    <section class="section featured-product wow fadeInUp">
                        <h3 class="section-title">
                            @if(Session::get('language')=='english'){{ $skip_brand_0->brand_name_english }}
                            @else{{ $skip_brand_0->brand_name_bangla }}
                            @endif
                        </h3>
                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"> <a href="{{ route('post.details',$blogPost->id) }}"><img src="{{ asset($blogPost->post_image) }}" alt=""></a> </div>
                                        </div>
                                        <!-- /.blog-post-image -->

                                        <div class="blog-post-info text-left">
                                            <h3 class="name"><a href="#">{{ $blogPost->post_title_english }}</a></h3>
                                            <span class="info">{{ \Carbon\Carbon::parse($blogPost->created_at)->diffForHumans() }}</span>
                                            <p class="text">{!!  Str::limit($blogPost->post_details_english,200) !!}</p>
                                            <a href="{{ route('post.details',$blogPost->id) }}" class="lnk btn btn-primary">Read more</a>
                                        </div>
                                        <!-- /.blog-post-info -->
