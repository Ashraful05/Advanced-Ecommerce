        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form action="{{ route('save.admin.user') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <img id="showImage" src="{{ url('upload/no_image.png') }}" style="height: 90px; width: 90px;" alt="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <fieldset>
                                                            <input type="checkbox" name="coupons" id="checkbox_6" value="1">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <fieldset>
                                                            <input type="checkbox" name="orders" id="checkbox_8" value="1">
                                                            <label for="checkbox_8">Orders</label>
                                                        </fieldset>

                                                        <fieldset>
                                                            <input type="checkbox" name="stock" id="checkbox_9" value="1">
                                                            <label for="checkbox_9">Stock</label>
                                                        </fieldset>

                                                        <fieldset>
                                                            <input type="checkbox" name="blog" id="checkbox_10" value="1">
                                                            <label for="checkbox_10">Blog</label>
                                                        </fieldset>

                                                        <fieldset>
                                                            <input type="checkbox" name="setting" id="checkbox_11" value="1">
                                            ...
                                            <div class="col-md-4">
                                                <fieldset>
                                                    <input type="checkbox" name="returns" id="checkbox_12"  value="1">
                                                    <label for="checkbox_12">Returns</label>
                                                </fieldset>

                                                <fieldset>
                                                    <input type="checkbox" name="review" id="checkbox_13" value="1">
                                                ...
                                                <fieldset>
                                                    <input type="checkbox" name="all_user" id="checkbox_15" value="1">
