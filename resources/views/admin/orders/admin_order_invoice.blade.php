...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
            ...
            <h2 style="color: green; font-size: 26px;"><strong>Easy Online Shop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Easy Online Shop Head Office
               Email:support@easylearningbd.com <br>
               Mob: 1245454545 <br>
               Sadipur 5310,Nilphamari:#4 <br>
    ...
    <tr>
        <td>
            <p class="font" style="margin-left: 20px;">
                ...
                <strong>Address:</strong> {{$division}},{{$district}},{{$area}} <br>
...
<table width="100%">
    ...
    @foreach($orderItem as $item)
        <tr class="font">
            ...
            <td align="center">{{ $item->product->product_name_english }}</td>
            <td align="center">
                @if( $item->size == '' )
                    -------
                @else
